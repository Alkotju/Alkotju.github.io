            ...
            "multipart/form-data">
                <table class="table table-bordered">
                    <tr>
                        ...
                        <td>
                            <input type='text' name='title' class="form-controll" required 
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea rows="5" name="text" class="form-controll" required readonly><?php
                            echo $detail['text'];?></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <select name="idCategory" class="form-controll" disabled>
                                <?php
                                foreach($arr as $row){
