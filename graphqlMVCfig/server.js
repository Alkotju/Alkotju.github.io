...
//Middleware для раздачи статическиз файлов из папки 'public'
...
app.use('/graphql', graphqlHTTP({
    ...
    graphiql: true, //Включаем GraphQL - удобный инструмент для тестирования GraphQL запросов в браузере
})),
...
// --- Запуск сервера
// Опрееляем порт, на котором будет работать сервер
const PORT = process.env.PORT || 4001;

//Синхронизируем модели с базой данных и запускаем сервер
sequelize.sync()
.then(()=>{
